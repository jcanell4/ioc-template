            ...
            array (
              ...
              array (
                ...
                array (
                  ...
                  'getQuery' => 'function(_data){var _ret=null; _ret=\'\';if (this.dispatcher.getGlobalState().currentTabId) { var globalState = this.dispatcher.getGlobalState(); var ns = globalState.getContent(globalState.currentTabId).ns; var pType = globalState.getContent(globalState.currentTabId).projectType; var pMoodleToken = globalState.getLoginState(\'moodleToken\'); _ret=(this.query) ? this.query + \'&id=\'+ns : \'id=\'+ns; if (pType && pType!==\'\' && pType!==undefined) _ret+=\'&projectType=\'+pType; if (pMoodleToken && pMoodleToken!==\'\' && pMoodleToken!==undefined) _ret+=\'&moodleToken=\'+pMoodleToken; }return _ret;}',
                ),
              ),
            ),
            'iYa_ftp_project' =>
            array (
              ...
              array (
                ...
                array (
                  ...
                  'disableOnSend' => true,
                  'urlBase' => '\'lib/exe/ioc_ajax.php?call=project\'',
                  'getQuery' => 'function(_data){var _ret=null; _ret=\'\';var globalState = this.dispatcher.getGlobalState();if (globalState.currentTabId) { var ns = globalState.getContent(globalState.currentTabId).ns; _ret=(this.query) ? this.query + \'&id=\'+ns : \'id=\'+ns; var pType = globalState.getContent(globalState.currentTabId).projectType; if (pType && pType!==\'\' && pType!==undefined) _ret+=\'&projectType=\'+pType; var pMoodleToken = globalState.getLoginState(\'moodleToken\'); if (pMoodleToken && pMoodleToken!==\'\' && pMoodleToken!==undefined) _ret+=\'&moodleToken=\'+pMoodleToken;}return _ret;}',
                ),
              ),
            ),
            'iZ0_rename_project' =>
