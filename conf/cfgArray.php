            ...
            array (
              ...
              array (
                ...
                array (
                  ...
                  'disableOnSend' => true,
                  'getQuery' => 'function(_data){var _ret=null; _ret=\'\';if (this.dispatcher.getGlobalState().currentTabId) { var globalState = this.dispatcher.getGlobalState(); var ns=globalState.getContent(globalState.currentTabId).ns; var rev = globalState.getCurrentContent().rev; if(this.query){ _ret=this.query + \'&id=\' + ns; }else{ _ret=\'id=\' + ns; } if (rev) { _ret+=\'&rev=\' + rev; } _ret+=this.dispatcher.getDraftManager().generateLastLocalDraftTimesParam(globalState.currentTabId, ns); _ret+=\'&contentFormat=\' + globalState.userState[\'editor\'];}return _ret;}',
                ),
              ),
            ),
            'i4_edit_project' => 
            array (
              ...
              array (
                ...
                array (
                  ...
                  'urlBase' => '\'lib/exe/ioc_ajax.php?call=project\'',
                  'disableOnSend' => true,
                  'getQuery' => 'function(_data){var _ret=null; _ret=\'\';if (this.dispatcher.getGlobalState().currentTabId) { var globalState=this.dispatcher.getGlobalState(); var ns=globalState.getContent(globalState.currentTabId).ns; var rev=globalState.getCurrentContent().rev; var projectType=globalState.getContent(globalState.getCurrentId()).projectType; var metaDataSubSet=globalState.getContent(globalState.getCurrentId()).metaDataSubSet; if (!metaDataSubSet) metaDataSubSet=globalState.getContent(globalState.currentTabId).metaDataSubSet; var localDraft=this.dispatcher.getDraftManager().getContentLocalDraft(ns,metaDataSubSet); var hasDraft; if(localDraft && localDraft.project && localDraft.project.metaDataSubSet===metaDataSubSet) hasDraft=true; if(this.query) _ret=this.query+\'&\'; _ret+=\'id=\'+ns+\'&projectType=\'+projectType; if(metaDataSubSet) _ret+=\'&metaDataSubSet=\'+metaDataSubSet; if(hasDraft) _ret+=\'&hasDraft=true\'; else _ret+=\'&noTieneDraftLocal=true\'; if(rev) _ret+=\'&rev=\'+rev; _ret+=this.dispatcher.getDraftManager().generateLastLocalDraftTimesParam(globalState.currentTabId, ns); _ret+=\'&contentFormat=\'+globalState.userState[\'editor\'];}return _ret;}',
                ),
              ),
            ),
            'i5_edparc' => 
            ...
            array (
              ...
              array (
                ...
                array (
                  ...
                  'getDataEventObject' => 'function(_data){var _ret=null; if (this.ok==true){ var globalState=this.dispatcher.getGlobalState(); var id=globalState.getCurrentId(); var ns=globalState.getContent(globalState.currentTabId)[\'ns\']; var pType = globalState.getContent(id).projectType; _ret = { id: id, name: \'remove_project\', dataToSend: {id: ns, projectType: pType} };}return _ret;}',
                  'onClick' => 'function(_data){var _ret=null; var globalState=this.dispatcher.getGlobalState();if (globalState.currentTabId) { var id=globalState.getCurrentId(); this.ok=confirm(\'Vols eliminar el projecte\\n\\t\\\'\'+globalState.getContent(id).projectType+\'\\\'?\');}return _ret;}',
                ),
              ),
            ),
          ),
