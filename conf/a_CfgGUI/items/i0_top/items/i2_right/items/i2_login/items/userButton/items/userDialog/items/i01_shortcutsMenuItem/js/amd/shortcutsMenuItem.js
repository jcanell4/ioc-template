...
if (shortcutsOption) {
   ...
   processorUser.addErrorAction("7101", function () {
       requestUser.urlBase = "lib/exe/ioc_ajax.php?call=new_page&template=cfgIdConstants::TEMPLATE_SHORTCUTS_NS&user_id="+shortcutsOption.dispatcher.getGlobalState().userId;
