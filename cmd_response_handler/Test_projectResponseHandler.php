...
class Test_projectResponseHandler extends New_pageResponseHandler
{

    protected function response($requestParams, $responseData, &$ajaxCmdResponseGenerator)
    {
        $containerClass = "ioc/gui/ContentTabDokuwikiNSTree";
        $urlBase = "lib/plugins/ajaxcommand/ajax.php?call=page";
        $urlTree = "lib/plugins/ajaxcommand/ajaxrest.php/ns_tree_rest/";

        $params = array(
            "id" => $responseData['id']/*cfgIdConstants::TB_PROJECT*/,
            "type" => "meta_dokuwiki_ns_tree",
            "title" => $responseData['title'],
            "standbyId" => cfgIdConstants::BODY_CONTENT,
//            "urlBase" => $urlBase,
            "fromRoot" => $responseData['ns'],
//            "data" => "TODO: Aqui s'ha de mostrar la informació del projecte",
        ...
        $ajaxCmdResponseGenerator->addMetadata(cfgIdConstants::TB_PROJECT, [$params]);


//        $ajaxCmdResponseGenerator->addAddTab(cfgIdConstants::ZONA_METAINFO,
//            $contantParams,
