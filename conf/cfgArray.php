            ...
            array (
              ...
              array (
                ...
                array (
                  ...
                  'getDataEventObject' => 'function(_data){var _ret=null; var globalState = this.dispatcher.getGlobalState();var id = globalState.getCurrentId();var contentToolActual = this.dispatcher.getContentCache(id).getMainContentTool();var ns = contentToolActual.ns;_ret = { id: id, name: \'save\', extraDataToSend: {do: \'save_rev\'}};return _ret;}',
                ),
              ),
            ),
            'i1save' => 
            ...
            array (
              ...
              array (
                ...
                array (
                  ...
                  'getDataEventObject' => 'function(_data){var _ret=null; var globalState = this.dispatcher.getGlobalState();var id = globalState.getCurrentId();_ret = { id: id, name: \'cancel\', dataToSend: {keep_draft: false}, projectOwner: globalState.getContent(globalState.currentTabId).projectOwner, projectSourceType: globalState.getContent(globalState.currentTabId).projectSourceType};return _ret;}',
                ),
              ),
            ),
            'i3_cancel_project' => 
            ...
            array (
              ...
              array (
                ...
                array (
                  ...
                  'disableOnSend' => true,
                  'getQuery' => 'function(_data){var _ret=null; _ret=\'\';if (this.dispatcher.getGlobalState().currentTabId) { var globalState = this.dispatcher.getGlobalState(); var ns=globalState.getContent(globalState.currentTabId).ns; var rev = globalState.getCurrentContent().rev; if(this.query){ _ret=this.query + \'&id=\' + ns; }else{ _ret=\'id=\' + ns; } if (rev) { _ret+=\'&rev=\' + rev; } _ret+=this.dispatcher.getDraftManager().generateLastLocalDraftTimesParam(globalState.currentTabId, ns); _ret+=\'&editorType=\' + globalState.userState[\'editor\']; _ret+=\'&projectOwner=\' + globalState.getContent(globalState.currentTabId).projectOwner; _ret+=\'&projectSourceType=\' + globalState.getContent(globalState.currentTabId).projectSourceType;}return _ret;}',
                ),
              ),
            ),
            'i4_edit_project' => 
            array (
              ...
              array (
                ...
                array (
                  ...
                  'urlBase' => '\'lib/exe/ioc_ajax.php?call=project\'',
                  'disableOnSend' => true,
                  'getQuery' => 'function(_data){var _ret=null; _ret=\'\';if (this.dispatcher.getGlobalState().currentTabId) { var globalState=this.dispatcher.getGlobalState(); var ns=globalState.getContent(globalState.currentTabId).ns; var rev=globalState.getCurrentContent().rev; var projectType=globalState.getContent(globalState.getCurrentId()).projectType; var metaDataSubSet=globalState.getContent(globalState.getCurrentId()).metaDataSubSet; if (!metaDataSubSet) metaDataSubSet=globalState.getContent(globalState.currentTabId).metaDataSubSet; var localDraft=this.dispatcher.getDraftManager().getContentLocalDraft(ns,metaDataSubSet); var hasDraft; if(localDraft && localDraft.project && localDraft.project.metaDataSubSet===metaDataSubSet) hasDraft=true; if(this.query) _ret=this.query+\'&\'; _ret+=\'id=\'+ns+\'&projectType=\'+projectType; if(metaDataSubSet) _ret+=\'&metaDataSubSet=\'+metaDataSubSet; if(hasDraft) _ret+=\'&hasDraft=true\'; else _ret+=\'&noTieneDraftLocal=true\'; if(rev) _ret+=\'&rev=\'+rev; _ret+=this.dispatcher.getDraftManager().generateLastLocalDraftTimesParam(globalState.currentTabId, ns); _ret+=\'&editorType=\'+globalState.userState[\'editor\'];}return _ret;}',
                ),
              ),
            ),
            'i5_edparc' => 
