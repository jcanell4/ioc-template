            ...
            array (
              ...
              array (
                ...
                array (
                  ...
                  'disableOnSend' => true,
                  'urlBase' => '\'lib/exe/ioc_ajax.php?call=project\'',
                  'getQuery' => 'function(_data){var _ret=null; _ret=\'\';var globalState = this.dispatcher.getGlobalState();if (globalState.currentTabId) { var ns = globalState.getContent(globalState.currentTabId).ns; _ret=(this.query) ? this.query + \'&id=\'+ns : \'id=\'+ns; var pType = globalState.getContent(globalState.currentTabId).projectType; if (pType && pType!==\'\' && pType!==undefined) _ret+=\'&projectType=\'+pType;}return _ret;}',
                ),
              ),
            ),
            'iZ0_rename_project' => 
