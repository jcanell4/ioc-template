...
class RequiredParamNotFoundException extends WikiIocTplGeneratorException {
    public function __construct($param, $message="Required param %s not found", 
                                                $code=2001, $previous=NULL) {
...
class UnknownTypeParamException extends WikiIocTplGeneratorException {
    public function __construct($type, $message="The param type %s is unknown", 
                                                $code=2002, $previous=NULL) {
        parent::__construct(sprintf($message, $page), $code, $previous);
    }
}
class FileScriptNotFoundException extends WikiIocTplGeneratorException {
    public function __construct($file, $message="File %s not found", 
                                                $code=2003, $previous=NULL) {
        parent::__construct(sprintf($message, $page), $code, $previous);
    }
}
