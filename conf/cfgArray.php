            ...
            array (
              ...
              array (
                ...
                array (
                  ...
                  'getDataEventObject' => 'function(){var _ret=null; _ret = {};var id = this.dispatcher.getGlobalState().getCurrentId(), chunk = this.dispatcher.getGlobalState().getCurrentSectionId();chunk = chunk.replace(id + \'_\', \'\');chunk = chunk.replace(\'container_\', \'\');_ret = { id: id, chunk: chunk, name: \'edit_partial_\' + id};return _ret;}',
                ),
              ),
            ),
            'i5a_saveparc' => 
            array (
              ...
              array (
                ...
                array (
                  ...
                  'getDataEventObject' => 'function(){var _ret=null; _ret = {};var id = this.dispatcher.getGlobalState().getCurrentId(), chunk = this.dispatcher.getGlobalState().getCurrentSectionId();chunk = chunk.replace(id + \'_\', \'\');chunk = chunk.replace(\'container_\', \'\');_ret = { id: id, chunk: chunk, name: \'save_partial_\' + id};return _ret;}',
                ),
              ),
            ),
            'i5b_cancelparc' => 
            array (
              ...
              array (
                ...
                array (
                  ...
                  'getDataEventObject' => 'function(){var _ret=null; _ret = {};var id = this.dispatcher.getGlobalState().getCurrentId(), chunk = this.dispatcher.getGlobalState().getCurrentSectionId();chunk = chunk.replace(id + \'_\', \'\');chunk = chunk.replace(\'container_\', \'\');_ret = { id: id, chunk: chunk, name: \'cancel_partial_\' + id};return _ret;}',
                ),
              ),
            ),
            'i7_supressio' => 
