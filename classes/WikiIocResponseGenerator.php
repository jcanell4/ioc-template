...
/**
 * Description of WikiIocResponseGenerator
 *
 * @author Josep Cañellas <jcanell4@ioc.cat>
 */
class WikiIocResponseGenerator {
    const DATA_TYPE=0;
    const TITLE_TYPE=1;
    const INFO_TYPE=2;
    ...
    //login (true/false)
    //load page (page_id, page_content)
    //edit page (page_id, page_content)
    //remove page (page_id, true/false)
    //
