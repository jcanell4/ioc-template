                    ...
                    array (
                      ...
                      array (
                        ...
                        array (
                          ...
                          'getQuery' => 'function(){var _ret=NULL; return \'id=wiki:user:\' + wikiIocDispatcher.getGlobalState().userId;return _ret;}',
                        ),
                      ),
                    ),
                    'i1_talkUserMenuItem' => 
                    array (
                      ...
                      array (
                        ...
                        array (
                          ...
                          'urlBase' => '\'lib/plugins/ajaxcommand/ajax.php?call=page\'',
                          'standbyId' => '\'bodyContent\'',
                          'getQuery' => 'function(){var _ret=NULL; return \'id=talk:wiki:user:\' + wikiIocDispatcher.getGlobalState().userId;return _ret;}',
                        ),
                      ),
                    ),
                    'i2_logoffMenuItem' => 
            ...
            array (
              ...
              array (
                ...
                array (
                  ...
                  'getQuery' => 'function(){var _ret=NULL; var ns=wikiIocDispatcher.getGlobalState().pages[wikiIocDispatcher.getGlobalState().currentTabId][\'ns\'];if(this.query){ _ret=this.query + \'&id=\' + ns;}else{ _ret=\'id=\' + ns;}return _ret;}',
                ),
              ),
            ),
            'i1_save' => 
            array (
              ...
              array (
                ...
                array (
                  ...
                  'getPostData' => 'function(){var _ret=NULL; _ret=domForm.toObject(\'dw__editform\');return _ret;}',
                  'getQuery' => 'function(){var _ret=NULL; var ns=wikiIocDispatcher.getGlobalState().pages[wikiIocDispatcher.getGlobalState().currentTabId][\'ns\'];if(this.query){ _ret=this.query + \'&id=\' + ns;}else{ _ret=\'id=\' + ns;}return _ret;}',
                ),
              ),
            ),
            ...
            array (
              ...
              array (
                ...
                array (
                  ...
                  'standbyId' => '\'bodyContent\'',
                  'urlBase' => '\'lib/plugins/ajaxcommand/ajax.php?call=edit\'',
                  'getQuery' => 'function(){var _ret=NULL; var q=dwPageUi.getFormQueryToEditSection(wikiIocDispatcher.getGlobalState().getCurrentSectionId());if(this.query){ _ret=this.query + \'&\' + q;}else{ _ret=q;}return _ret;}',
                ),
              ),
            ),
            'i7_exit' => 
